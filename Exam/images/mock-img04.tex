...
\begin{tikzpicture}
    ...
    \draw (0,2) -- (2,4);
    \draw (2,0) -- (4,2);
    \node (A) [right=10pt,below] at (0,4) {\tiny $(1,4)$};
    \node (B) [right=10pt,below] at (2,4) {\tiny $(7,2)$};
    \node [right=10pt,below] at (2,2) {\tiny $(2,1)$};
    \node [right=10pt,below] at (0,2) {\tiny $(1,1)$};
    \node [left=10pt,above] at (2,2) {\tiny $(.4,.6)$};
    \node [left=10pt,above] at (4,2) {\tiny $(0,1)$};
