    ...
    \node[player]{a: 1}
        child {node[player] {c: 2}
                child {node (E) [player] {e: 1}
                    child {node[end] {} node [right] {$(3,-1)$} edge from parent node[below] {H}}
                    child {node[end] {} node [right] {$(-1,2)$} edge from parent node[below] {T}}
                        edge from parent node[below] {H}}
                child {node (D) [player] {d: 1}
                    child{node[end] {} node [right] {$(-4,2)$} edge from parent node[below] {X}}
                    child{node[end] {} node [right] {$(1,-2)$} edge from parent node[below] {Y}}
                edge from parent node[below] {T}}
edge from parent node[below] {B}}
        child {node[player] {b: 2}
                child {node[end] {} node[right] {$(1,1)$} edge from parent node[below] {C}}
                child {node[end] {} node[right] {$(2,2)$} edge from parent node[below] {D}}
