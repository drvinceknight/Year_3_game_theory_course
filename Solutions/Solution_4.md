...
5. Obtain the Markov Nash equilibrium (in pure strategies if it exists) for the following games assuming $\delta=1/4$.
    ...
    **Solution**
    ...
    4. $(a,b)$ which requires: $2+u/4\leq 1+u/40$ and $2+v/40\geq 0$ $\Rightarrow$ $u\leq -40/9$ and $v\geq -80$. However if this is the equilibria then $u=40/39$ and $v=80/39$ which contradicts the constraints.
