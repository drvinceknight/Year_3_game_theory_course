...
\begin{tikzpicture}
    ...
    \draw (0,2) -- (2,4);
    \draw (2,0) -- (4,2);
    \node (A) [right=10pt,below] at (0,4) {\tiny $(1,3)$};
    \node (B) [right=10pt,below] at (2,4) {\tiny $(2,1)$};
    \node [right=10pt,below] at (2,2) {\tiny $(1,2)$};
    \node [right=10pt,below] at (0,2) {\tiny $(7,0)$};
    \node [left=10pt,above] at (2,2) {\tiny $(.8,.8)$};
    \node [left=10pt,above] at (4,2) {\tiny $(1,0)$};
    \node (X) [left=10pt,above] at (2,0) {\tiny $(0,1)$};
    \node (Y) [left=10pt,above] at (4,0) {\tiny $(.1,.9)$};

    \draw [rectangle] (5,0) -- (7,0) -- (7,2) -- (5,2) -- cycle;
    \draw (5,0) -- (7,2);
    \node (C) [right=10pt,below] at (5,2) {\tiny $(0,0)$};
    \node (Z) [left=10pt,above] at (7,0) {\tiny $(.5,.5)$};
