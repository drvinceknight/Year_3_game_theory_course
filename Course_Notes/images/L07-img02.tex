...
\begin{tikzpicture}[grow=right, sloped]
    ...
    \node[player]{a: Bob}
        ...
        child {node[player] {c: Celine}
                child {node[end] {} node[right] {$(0,0)$} edge from parent node[below] {Comedy}}
                child {node[end] {} node[right] {$(2,3)$} edge from parent node[below] {Sports}} edge from parent node[below] {Sports}};
    \node (2ndroot) [player] at (0,4) {d: Bob};
    \node (2ndend) [end] at (3.5,6) {};
    \node[right] at (3.5,6) {$(7,2)$};
        \draw [black] (2ndroot) -- (2ndend);
        \draw [black] (2ndroot) -- (1stC);
        \draw [red,very thick] (-1,-3) -- (8,6);
        \draw [red,very thick] (-1,6) -- (8,-3);
\end{tikzpicture}
\end{document}
